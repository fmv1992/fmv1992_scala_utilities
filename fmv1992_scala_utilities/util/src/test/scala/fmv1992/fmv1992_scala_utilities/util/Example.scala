...
object Example {
  ...
  val cli01Path: String = "./util/src/test/resources/test_cli_example_01.txt"
  ...
  val cli05Path: String =
    "./util/src/test/resources/test_cli_example_05_sum.txt"
